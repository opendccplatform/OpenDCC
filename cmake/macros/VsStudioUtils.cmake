...
if(DCC_MAKE_VSDEBUG_LAUNCHER
   ...
   OR DCC_MAKE_DOT_ENV_FILE)
    ...
    if(DCC_QT_INSTALL_PREFIX)
        list(APPEND ENV_PATH ${DCC_QT_INSTALL_PREFIX}/bin)
    else()
        message(FATAL_ERROR "DCC_QT_INSTALL_PREFIX is not defined")
    endif()
    if(DEFINED OSL_ROOT)
    ...
    # test the target, not the Qt5-only qtadvanceddocking_DIR - ADS 4.x (Qt6) sets
    # qtadvanceddocking-qt6_DIR instead
    if(TARGET ${DCC_ADS_TARGET})
        ...
        message(FATAL_ERROR "ADS target ${DCC_ADS_TARGET} not found")
    endif()
